/**
 * This file is part of Breezy Weather Geometric Icon Provider.
 *
 * Breezy Weather Geometric Icon Provider is free software: you can redistribute it and/or modify it
 * under the terms of the GNU Lesser General Public License as published by the
 * Free Software Foundation, version 3 of the License.
 *
 * Breezy Weather Geometric Icon Provider is distributed in the hope that it will be useful, but
 * WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY
 * or FITNESS FOR A PARTICULAR PURPOSE. See the GNU Lesser General Public
 * License for more details.
 *
 * You should have received a copy of the GNU Lesser General Public License
 * along with Breezy Weather Geometric Icon Provider. If not, see <https://www.gnu.org/licenses/>.
 */

package org.breezyweather.geometriciconprovider
...
class SunDrawable : Drawable() {
    ...
    private val mColors = intArrayOf(
        Color.rgb(255, 141, 85),
        Color.rgb(255, 103, 89)
    )
